...
{
	 //$this->load->view('colombia', array('error' => ' ' ));
...
public function do_upload()
	{
		...
		$nombreOportunidad='Oportunidad_Beca_Colombia';
		$idCampaña='a0M1a000004Z0f2';
...
//			$url_ce='clasejec3.ing.puc.cl/apps/index.php?/seguimiento_controller/insertarPersonaOportunidadLandingBecaSF/'.$email.'/'.$nombre.'/'.$apellido.'/'.$telefono.'/'.$cargo.'/'.$empresa.'/'.$pais.'/'.$region.'/'.$comentario.'/'.$origen.'/'.$acepta.'/'.$productos.'/'.$nombreOportunidad.'/'.$idCampaña.'/'.$p_ruta1.'/'.$p_ruta2.'/'.$p1.'/'.$p2.'/'.$anhos;
