...
<script type="text/javascript" src="/contents/js/validate.min.js" ></script> 
 <script src="/contents/js/v1.js" ></script> 
...
<div  class="col-md-2 field-label-responsive"><strong> Pais de Origen: </strong></div>
			<div class="col-md-3">
		...
		<div class="form-group row">
		  <div  class="col-md-3 field-label-responsive"><strong> Género: </strong></div>
			<div class="col-md-3">
...
<div class="card card-body">
		...
		<div  class="form-group row">
			<div  class="col-md-6 field-label-responsive"><font size=3><strong>Domicilio / Residencia:</strong><p style="color:red;">(campos obligatorios)</p></font></div>
        </div>


		<div class="form-group row">
		<div  class="col-md-3 field-label-responsive"><strong> País : </strong></div>
			<div class="col-md-3">
			  <Select type="text" name="pais_aux" id="pais_aux" class="form-control" placeholder="Pais"  >
                        <option value="" selected>Seleccione país</option>
...
<div class="form-group row">			
	...
	<div  class="col-md-3 field-label-responsive d-none"id="label-comuna"><strong> Comuna: </strong></div>
...
<div class="card card-body">
		...
		<div  class="form-group row">
			<div  class="col-md-6 field-label-responsive"><font size=3><strong>Datos de Contacto:</strong><p style="color:red;">(campos obligatorios)</p></font></div>
        </div>		
		<div class="form-group row">			
...
<div class="card card-body">		
		...
		<div  class="form-group row" >
			<div  class="col-md-6 field-label-responsive"><font size=3><strong>Forma de Pago:</strong></font></div>
...
<!-- select Medio de Pago-->
	...
	<select id="mpchile" name="mpago" class="selectpicker" data-max-options="2" multiple  data-width="auto" multiple data-selected-text-format="values" title="Selecciona tu Medio Pago ...">
...
<br>
	...
	<select  name="mpago" class="selectpicker" data-max-options="1" multiple  data-width="auto" title="Selecciona tu Medio Pago ...">
	  <option value="8">Transferencia Bancaria Internacional</option>
	  <option value="5">Cuponera</option>
	</select>
	</div>
...
<br>
	...
	<div  class="form-group row">
			...
			<div class="col-md-3">	
				<input type="button" class="btn btn-primary"id="btAdd" value="Subir documento" class="bt" />
			</div>	
			<div class="col-md-3">
