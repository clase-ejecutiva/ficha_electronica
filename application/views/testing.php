...
<script type="text/javascript" src="/landing/contents/js/validate.min.js" ></script> 
 ...
 <script src="/landing/contents/js/dropzone.js" ></script> 
	 ...
	 <hr> 
		...
		<?php
			foreach ($jsondecode->productos as $k){
				...
				echo "<td>".$k->Name."</td>";
				echo "<td>".'<button type="button"   class="btn btn-warning d " id="malla" onclick="malla_diplo('.$k->ProductCode.')" >Ver</button>'."</td>";
				echo "</tr>";
				}
  ...
  <div class="modal-dialog modal-lg" role="document">
	...
	<!--Disclaimer -->		
       ...
       <!--Datos Personales -->
		  ...
		  <div  class="col-md-3 field-label-responsive"  id="txt_tipo_documento" ><strong> Tipo de Identificacion: </strong></div>
			<div class="col-md-3"  id="div_tipo_documento">
				 <select type="text" name="tipo_documento" class="form-control" id="tipo_documento" placeholder="DNI O PASSAPORTE">
								  ...
								  <option value="Passaporte(3)">Passaporte</option>
				</select>
			</div>
		...
		<div class="col-md-3">
			  <input type="text" id="dni" name="dni"class="form-control" placeholder="DNI o RUT" size="10" maxlength="10" value="<?php if($jsondecode){echo $jsondecode->dataCta->fields->RUT__c;}else{echo '';} ?>" >
		</div>		
		...
		<div class="form-group row">
		  <div  class="col-md-3 field-label-responsive"><strong>Fecha de Nacimiento: </strong></div>
			<div class="col-md-3">
			  <input type="text" name="f_nacimiento"class="form-control" id="f_nacimiento" value="" >
		    </div>
...
<!--Fin del Modal -->	
		...
		<div class="form-check form-check-inline d" id="inlineCheckbox1">
		  <input class="form-check-input" name="mpago" type="radio" id="DataCheckbox1" value="8">
		...
		<div class="form-check form-check-inline d" id="inlineCheckbox2">
		  <input class="form-check-input" name="mpago" type="radio" id="DataCheckbox2" value="2">
		...
		<div class="form-check form-check-inline d" id="inlineCheckbox3">
		  <input class="form-check-input" name="mpago" type="radio" id="DataCheckbox3" value="3">
		   <a class="form-check-label" data-toggle="modal" href="#ModalOC">Orden de Compra</a>
		</div>	

		<div class="form-check form-check-inline d" id="inlineCheckbox8">
		  <input class="form-check-input" name="mpago" type="radio" id="DataCheckbox8" value="4">
		  <a class="form-check-label" data-toggle="modal" href="#OC/OTIC">Orden de Compra/OTIC</a>
		</div>	
		
		<br><br>
		  <div class="form-check form-check-inline d"id="inlineCheckbox4" >
		  <input class="form-check-input " name="mpago" type="radio" id="DataCheckbox4" value="5">
		...
		<div class="form-check form-check-inline d" id="inlineCheckbox5">
		  <input class="form-check-input" name="mpago" type="radio" id="DataCheckbox5" value="6">
		...
		<div class="form-check form-check-inline d" id="inlineCheckbox6">
		  <input class="form-check-input" name="mpago" type="radio" id="DataCheckbox6" value="7">
		...
		<div class="form-check form-check-inline d" id="inlineCheckbox7">
		  <input class="form-check-input" name="mpago" type="radio" id="DataCheckbox7" value="1">
		...
		<div  class="form-group row" >
		 ...
		 <div class="col-md-4">
			<Select type="text" name="tipo_p" id="tipo_p" class="form-control" placeholder="Tipo de Persona"  >
                                                    ...
                                                    <option value='Juridica(2)'> Empresa</option>
													 <option value='Natural(1)'> Alumno</option>
...
<!--Datos de Pago class="d-none" -->
		...
		<div  class="col-md-3 field-label-responsive"><strong> Nombre del Pagador: </strong></div> 
		 <div class="col-md-3">
			<input type="text" id="id_nom_pn" name="nom_pn_a"class="form-control" placeholder="nombre" ">
		 </div>
		 
		<div  class="col-md-2 field-label-responsive"><strong> Apellido del Pagador: </strong></div>
		<div class="col-md-3">
			 <input type="text"  id="id_ape_pn" name="ape_pn_a"class="form-control" placeholder="Apellido" >
		</div>		 
		 
		</div>
		
		<div class ="form-group row">
			<div class="col-md-3 field-label-responsive"><strong>Rut del Alumno</strong></div>
			<div class="col-md-3">
			 <input type="text" id="id_rut_alumno" name="rut_ficha_a"class="form-control" placeholder="Rut" size="10" maxlength="10" >
		</div>
		...
		<!--Datos de Pago Tercero" -->
		<div id="datosPagoTercero" class="d-none">	
	      <div  class="form-group row" >
			<div  class="col-md-6 field-label-responsive"><strong>Tercero:</strong></div>
		...
		<div  class="col-md-3 field-label-responsive"><strong> Nombre del Pagador: </strong></div> 
		 <div class="col-md-3">
			<input type="text"  name="nom_pn_t"class="form-control" placeholder="nombre" value="">
		 </div>
		 
		<div  class="col-md-2 field-label-responsive"><strong> Apellido del Pagador: </strong></div>
		<div class="col-md-3">
			 <input type="text"   name="ape_pn_t"class="form-control" placeholder="Apellido" value="">
		</div>		 
		 
		</div>
		
		<div class ="form-group row">
			<div class="col-md-3 field-label-responsive"><strong>Rut del Pagador</strong></div>
			<div class="col-md-3">
			 <input type="text" name="rut_ficha_t"class="form-control" placeholder="Rut" size="10" maxlength="10" value="">
			</div>
			
		<div  class="col-md-2 field-label-responsive"><strong> Correo Electronico: </strong></div>
		<div class="col-md-3">
			 <input type="email"   name="email_pagador"class="form-control" placeholder="contacto@claseejecutiva.cl" value="">
		</div>			
		...
		<div class ="form-group row">
		<div class="col-md-3 field-label-responsive"><strong>Rut Empresa</strong></div>
		<div class="col-md-3">
		 <input type="text" name="rut_ficha_e"class="form-control" placeholder="Rut" size="10" maxlength="10" value="">
		</div>
		
		<div  class="col-md-2 field-label-responsive"><strong> Rut Representante Legal: </strong></div>
		<div class="col-md-3">
			 <input type="text" name="rut_rl"class="form-control" placeholder="Rut" size="10" maxlength="10" value="">
		</div>			
		</div>
		
		
		<div class ="form-group row d-none" id="tipo_otic">
		<div class="col-md-3 field-label-responsive"><strong>OTIC</strong></div>
		<div class="col-md-3">
			<Select type="text" name="tipo_otic"  class="form-control" placeholder="Selecionar"  >
			  <option value="" selected>Seleccione.</option>
			  <option value='1'>Intermediación para el desarrollo de las personas.</option>
			  <option value='2'>Asexma</option>
			  <option value='3'>ASIMET</option>
			  <option value='4'>Cámara Chilena Construcción</option>
			  <option value='5'>CAPFRUTA</option>
			  <option value='6'>Corporación de Capacitación Tecnologías ACTI</option>
			  <option value='7'>Corporación de la Banca para la promoción de la Capacitación</option>
			  <option value='8'>Corporación de la C.N.C.</option>
			  <option value='9'>Corporación Fide de Capacitación</option>
			  <option value='10'>Otic Agrocap</option>
			  <option value='11'>Otic Chile Vinos</option>
			  <option value='12'>OTIC FRANCO CHILENA</option>
			  <option value='13'>Otic ProAconcagua</option>
			  <option value='14'>OTIC Regional O´Higginns</option>
			  <option value='15'>PROFORMA</option>
			  <option value='16'>PROMAULE</option>
			  <option value='17'>Sofofa</option>
			</Select>
		</div>
		...
		<div  class="col-md-3 field-label-responsive"><strong> Direccion: </strong></div> 
		 <div class="col-md-3">
			<input type="text" id="id_dir_pagador" name="dir_pagador"class="form-control" placeholder="direccion" value="">
		 </div>
		 
		<div  class="col-md-2 field-label-responsive"><strong> ciudad: </strong></div>
		<div class="col-md-3">
			 <input type="text" id="id_ciudad_pagador" name="ciudad_pagador"class="form-control" placeholder="ciudad" value="">
		</div>		 
		...
		<Select type="text" name="pais_pagador" id="id_pais_pagador" class="form-control" placeholder="Pais"  >
															<option value="" selected>Seleccione país</option>
		...
		<div class="col-md-3">
			 <input type="text" id="id_com_pagador" name="com_pagador"class="form-control" placeholder="comuna" value="">
		</div>		 
		...
		<div class="col-md-3">
			 <input type="text" name="tel_con"class="form-control" placeholder="+569" value="">
		</div>		 
