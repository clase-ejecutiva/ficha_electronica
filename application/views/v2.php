...
pais_step2='<?php echo $form2->pais_residencia;?>';
</script>
<style type="text/css">
.error {
  color: #d93636;
  ...
  <div class="row">
	...
	<div  class="card" >	
           ...
           <div  class="col-md-12 field-label-responsive"><br>	</div>				
			...
			<div  class="col-md-7 field-label-responsive">
				<b><?php if($jsondecode){echo $jsondecode->dataOp->fields->Monto_Final__c;}else{echo '';} ?></b>
			 </div> 
		 ...
		 <div  class="col-md-3 field-label-responsive"><strong> Apellido Materno: </strong></div>
			...
			<div class="col-md-3">
			   <Select type="text" name="estado_civil" id="estado_civil" class="form-control" placeholder="estado_civil"  >
			     <option value="" selected>Seleccionar</option>
                 <option value='A'>Acuerdo de Unión Civil</option>
   ...
   <div class="card">
		...
		<div class="form-group row">
		 ...
		 <div class="col-md-12"><br></div>
            ...
            <div  class="col-md-3 field-label-responsive"   ><strong> Pais de Residencia: </strong></div>
			<div class="col-md-3"  >
            ...
            <div  class="col-md-2 field-label-responsive"><strong> Region: </strong></div>
			<div class="col-md-3">
		  ...
		  <input type="text" id="id_region_extrangera" name="region_extrangera" class="form-control d-none" placeholder="ETC" value="">	
					    <Select type="text" id="id_region_residencia" name="region_residencia" class="form-control " placeholder="Region" >
		                                            ...
		                                            <option value='Arica y Parinacota_115'>Arica y Parinacota</option>
													<option value='Tarapacá_101'>Tarapacá</option>
													<option value='Antofagasta_102'>Antofagasta</option>
													<option value='Atacama_103'>Atacama</option>
													<option value='Coquimbo_104'>Coquimbo</option>
													<option value='Valparaíso_105'>Valparaíso</option>
													<option value='Metropolitana_113'>Metropolitana</option>
													<option value='Libertador General Bernardo OHiggins_106'>Libertador General Bernardo OHiggins</option>
													<option value='Maule_107'>Maule</option>
													<option value='Bío Bío_108'>Bío Bío</option>
													<option value='La Araucanía_109'>La Araucanía</option>
													<option value='Los Ríos_114'>Los Ríos</option>
													<option value='Los Lagos_110'>Los Lagos</option>
													<option value='Aysén del General Carlos Ibáñez del Campo_111'>Aysén del General Carlos Ibáñez del Campo</option>
													<option value='Magallanes y la Antártica Chilena_112'>Magallanes y la Antártica Chilena</option>	
                        </select>		
       <!--
	...
	<div class="form-group row">
		<div  class="col-md-3 field-label-responsive"  ><strong id="id_titulo_comuna_alumno"> Comuna: </strong></div>
			<div class="col-md-3">
			<input type="text" id="id_input_ciudad_extranjera"  name="ciudad_extranjera"class="form-control d-none"  placeholder="etc" value="">
      ...
      <div class="form-group row">
		...
		<div class="col-md-3 ">
		<button type="button" id="back"class="btn btn-primary btn-lg btn-block" onClick="back_step(1);">Atras</button>
		</div>
		   ...
		   <div class="card">
				...
				<div class="form-group row">
					<div class="col-md-2"><br></div>
						...
						<?php if($jsondecode){$monto=explode(' ',$jsondecode->dataOp->fields->Monto_Final__c);$valor=str_replace('.','',$monto[1]);echo 'Pagaré el total USD '.round($valor/$dolar_ce).',con Cuponera';}else{echo '';}?>
						</div>	
				</div>					
				...
				<div  class="col-md-4 field-label-responsive"><strong> <u id="id_layout_titulo_oc">Orden de Compra : <?php if($jsondecode){echo $jsondecode->dataOp->fields->Monto_Final__c;}else{echo '';}?></u></strong></div>
				<div  class="col-md-8 field-label-responsive"></div>
				<div  class="col-md-12 field-label-responsive"><br></div>
				<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-md-4">
						<input type="number" id="id_telefono_emp" name="telefono_emp"class="form-control"  size="200" maxlength="200" value="" >
						</div>			 
					</div>
					
					<div class="form-group row">
						<div  class="col-md-2 field-label-responsive"><strong> Atención: </strong>
						</div>
						...
						<div  class="col-md-2 field-label-responsive"><strong> Mail de Contacto: </strong>
						</div>
					...
					<div class="form-group row " id="boton_fin_mpago_oc">
						...
						<div class="col-md-3 ">
						<button type="button" id="back"class="btn btn-primary btn-lg btn-block" onClick="back_step(5);">Atras</button>
						</div>
						<div class="col-md-3">
				...
				<input type="text" id="id_total_cheque" name="total_cheque" class="form-control"  value="" readonly >
				...
				<div  class="col-md-2 field-label-responsive">Total Cheques</div>
				<div  class="col-md-3 field-label-responsive">
				<input type="number" id="id_total_cheque_terceros" name="total_cheque_terceros" class="form-control"  value="" readonly>
				</div>
				...
				<div  class="col-md-3 field-label-responsive">Deposito/Transferencia</div>
				
				<div  class="col-md-2 field-label-responsive">Total</div>
				<div  class="col-md-3 field-label-responsive">
				<input type="number" id="id_total_deposito" name="total_deposito" class="form-control"  value="" readonly>
				</div>
				...
				<div  class="col-md-3 field-label-responsive">
				<input type="number" id="id_total_pos" name="total_pos" class="form-control"  value="" readonly>
				</div>
				...
				<div  class="col-md-3 field-label-responsive">
				<input type="number" id="id_total_webpay" name="total_webpay" class="form-control"  value="" readonly>
				</div>
				...
				<div  class="col-md-3 field-label-responsive">
				<input type="number" id="id_total_oc_empresa" name="total_oc_empresa" class="form-control"  value="" readonly>
				</div>
               ...
               <div id="id_datos_persona_natural" class="form-group row d" >
				...
				<div  class="col-md-4 field-label-responsive"> <input type="text" id="id_otro_cheque_telefono" name="otro_cheque_telefono" class="form-control"  value=""> </div>
				<div  class="col-md-2 field-label-responsive"><br></div>				
				<div  class="col-md-2 field-label-responsive"><br></div>					
				...
				<div  class="col-md-4 field-label-responsive"> <input type="number" id="id_otro_cheque_totalapagar" name="otro_cheque_totalapagar" class="form-control"  value=""> </div>
				<div  class="col-md-2 field-label-responsive"><br></div>
				<div  class="col-md-2 field-label-responsive"><br></div>	
				...
				<div class="col-md-5"></div>
				<div class="col-md-3 ">
				<button type="button" id="back"class="btn btn-primary btn-lg btn-block" onClick="back_step(2);">Atras</button>
				</div>
				<div class="col-md-3">
				...
				<div class="col-md-3 ">
				<button type="button" id="back"class="btn btn-primary btn-lg btn-block" onClick="back_step(3);">Atras</button>
				</div>
				<div class="col-md-3">
...
<!--Fin upload-->
	 ...
	 <div class="form-group row">
		...
		<div class="col-md-4 ">
		<button type="button" id="back"class="btn btn-primary btn-lg btn-block" onClick="back_step(4);">Atras</button>
		</div>		 
